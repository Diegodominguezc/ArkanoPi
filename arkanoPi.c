...
TipoTeclado teclado = {
	...
	// A completar por el alumno...
	// ...
			.debounceTime= {0,0,0,0}, // Timeout to avoid bouncing after pin event
			.flags=0,
			.teclaPulsada = {-1,-1},  //No hay tecla pulsada
			.columna_actual= COLUMNA_1,  //Comenzamos por la primera columna
};
...
int main () {
	...
	fsm_trans_t arkanoPi[] = {
		...
		{ WAIT_PUSH, CompruebaPausa, WAIT_PAUSA, PausaJuego },
		{ WAIT_PAUSA, CompruebaPausa, WAIT_PUSH, PausaJuego },
